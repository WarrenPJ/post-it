var Note = React.createClass({
	...
	renderForm: function() {
		return (
			<div className="note" style={this.style}>
			<textarea ref="newNote" defaultValue={this.props.children} className="form-control" autoFocus></textarea>
			<button onClick={this.save} className="btn btn-success btn-sm glyphicon glyphicon-ok"/>
			</div>
		);
	},
    render: function() {
	...
	render: function() {
		return (
			<div className="board">
				...
				<button className="btn btn-success btn-sm glyphicon glyphicon-plus" onClick={this.add.bind(null, "")}/>
